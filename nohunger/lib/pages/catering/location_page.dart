...
class CateringLocationPage extends StatefulWidget {
  final Map<String, String> cateringInfo;

  const CateringLocationPage({
    super.key,
    required this.cateringInfo,
  });

  @override
  State<CateringLocationPage> createState() => _CateringLocationPageState();
}

class _CateringLocationPageState extends State<CateringLocationPage> {
  ...
  void _handleNext() {
    if (_formKey.currentState!.validate() && _selectedState != null) {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) =>
              CateringContactDetailsPage(cateringInfo: locationInfo),
        ),
      );
    }
  }
